...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/motor-development-services/',
    languages: {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose lg:prose-xl max-w-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 my-12">
              <Image src="/images/elect2.webp" alt="Electromagnetic Simulation" width={500} height={300} className="rounded-lg shadow-md" />
              <Image src="/images/mech2-993x1024.webp" alt="Mechanical Simulation" width={500} height={300} className="rounded-lg shadow-md" />
              <Image src="/images/therm1.webp" alt="Thermal Simulation" width={500} height={300} className="rounded-lg shadow-md" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 my-12">
                <Image src="/images/motor4.png" alt="Motor 4" width={500} height={300} className="rounded-lg shadow-md" />
                <Image src="/images/motor2-1011x1024.png" alt="Motor 2" width={500} height={300} className="rounded-lg shadow-md" />
                <Image src="/images/motor1.png" alt="Motor 1" width={500} height={300} className="rounded-lg shadow-md" />
            </div>
            ...
            <div className="my-12">
              <Image src="/images/Many1-1024x794.png" alt="Collaborative Partnerships" width={1024} height={794} className="rounded-lg shadow-md mx-auto" />
            </div>
          </div>
        </div>
      </div>    </main>
