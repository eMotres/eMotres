    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          className="block w-full shadow-sm py-3 px-4 placeholder-gray-500 focus:ring-brand focus:border-brand border-gray-300 rounded-md"
          placeholder="Hi! If possible, please specify the following parameters: Continuous Power, Continuous RPM, Peak Power, Peak RPM, Voltage, Cooling System, Required Weight, Required Efficiency. This will allow us to more accurately calculate the cost of manufacturing your custom motor."
          value={message}
