        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <Link href="/contact" className="text-gray-600 hover:text-brand px-3 py-2 rounded-md text-sm font-medium">Contacts</Link>
            </div>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden" id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link href="/contact" className="text-gray-600 hover:text-brand block px-3 py-2 rounded-md text-base font-medium">Contacts</Link>
          </div>
        </div>
      )}
    </nav>
